...
<head>
  ...
  <center>
    <h1>Crud PHP dan MySQL</h1>
    <h2>Beauty Ilkima Mariam</h2>
    <h3>Absen 06 Rpl 2</h3>
  </center>
...
if(isset($_POST['submit'])){
	...
	$student_kelas        = $_POST['kelas'];
	$student_absen        = $_POST['absen'];
	$student_result       = $_POST['result'];
	$Query = mysqli_query($con, "INSERT INTO students (name,kelas,absen,result) VALUES ('$student_name','$student_kelas', '$student_absen','$student_result')");
	if($Query){
      ...
      <div class="modal-body">
       <form method="POST" action="">
       	<div class="form-group">
       		<input type="text" name="student_name" class="form-control" placeholder="Masukan Nama..." required="">
       	</div><!-- form-group -->
       	<div class="form-group">
